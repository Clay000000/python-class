...
class Deck:
    ...
    def shuffle(self):
        ...
        print("The deck is shuffles fooligan get wit it my guy")

    def deal(self):
        return self.cards.pop()

class Player:
    def __init__(self, bank=69420):
        self.bank = bank
        self.bet = 0
...
# Funtions: win_check(), replay(), game_switch()
    ...
    if  player_hand.value == 21:
        ...
        print("The dealer has busted, so you won!")
        player.add_bank()
        player_hand.__del__()
        dealer_hand.__del__()
        ...
        print("Your hand is higher so you won!")
        player.add_bank()
        player_hand.__del__()
        dealer_hand.__del__()
    else:
        print("The dealers hand is higher, so you lost!")
        player_hand.__del__()
        dealer_hand.__del__()
        dealer_hand.show()
...
while game_on:
    print("Welcome to Clay's Blackjack Game")
